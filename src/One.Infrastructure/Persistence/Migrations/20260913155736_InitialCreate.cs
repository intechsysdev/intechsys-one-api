        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HomepageUrl = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    DocumentationUrl = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    SupportEmail = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    IsPublic = table.Column<bool>(type: "bit", nullable: false),
                    AvailableScopes = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Plan = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: true),
                    Notes = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    MaxApps = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppSettingDefinitions_Apps_AppId",
                        column: x => x.AppId,
                        principalTable: "Apps",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GrantedScopes = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenantAppId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(160)", maxLength: 160, nullable: false),
                    Environment = table.Column<int>(type: "int", nullable: false),
                    ClientId = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: false),
                    KeyPrefix = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    ...
                    SecretLast4 = table.Column<string>(type: "nvarchar(8)", maxLength: 8, nullable: false),
                    Scopes = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    AllowedIps = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
                    ExpiresAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApiCredentials_TenantApps_TenantAppId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TenantAppSettings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TenantAppSettings_AppSettingDefinitions_SettingDefinitionId",
                        column: x => x.SettingDefinitionId,
                        principalTable: "AppSettingDefinitions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_TenantAppSettings_TenantApps_TenantAppId",
                        column: x => x.TenantAppId,
                        principalTable: "TenantApps",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApiCredentials_ApiKeyHash",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApiCredentials_TenantAppId_Environment",
                table: "ApiCredentials",
                columns: new[] { "TenantAppId", "Environment" });

            migrationBuilder.CreateIndex(
                name: "IX_Apps_Category",
                table: "Apps",
                column: "Category");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppSettingDefinitions_AppId_Key",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TenantApps_AppId",
                table: "TenantApps",
                column: "AppId");

            migrationBuilder.CreateIndex(
                name: "IX_TenantApps_TenantId_AppId",
                table: "TenantApps",
                columns: new[] { "TenantId", "AppId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TenantAppSettings_SettingDefinitionId",
                table: "TenantAppSettings",
                column: "SettingDefinitionId");

            migrationBuilder.CreateIndex(
                name: "IX_TenantAppSettings_TenantAppId_Key_Environment",
                table: "TenantAppSettings",
                columns: new[] { "TenantAppId", "Key", "Environment" },
                unique: true);
